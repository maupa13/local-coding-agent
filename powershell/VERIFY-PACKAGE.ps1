...
$required=@(
 ...
 'tests\NEW-ACCEPTANCE-REPO.ps1','tests\NEW-RUST-GUARD-REPO.ps1','tests\NEW-DOC-SOURCE-REPO.ps1','tests\NEW-COMPLIANCE-REPO.ps1','tests\NEW-RELEASE-E2E-REPO.ps1','tests\VERIFY-PROJECT-BOOTSTRAP.ps1','tests\VERIFY-AGENTIC-PIPELINE.ps1','tests\VERIFY-NATIVE-OLLAMA-LOOP.ps1','tests\VERIFY-MICRO-RUNTIME.ps1',
 'powershell\DEV.ps1')
