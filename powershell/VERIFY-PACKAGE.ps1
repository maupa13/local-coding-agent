...
# Lifecycle scripts live under powershell/. Always resolve the repository root
# once so validation is independent of the caller's current working directory.
...
$required=@(
 ...
 'tests\NEW-ACCEPTANCE-REPO.ps1','tests\NEW-RUST-GUARD-REPO.ps1','tests\NEW-DOC-SOURCE-REPO.ps1','tests\NEW-COMPLIANCE-REPO.ps1','tests\NEW-RELEASE-E2E-REPO.ps1','tests\VERIFY-PROJECT-BOOTSTRAP.ps1','tests\VERIFY-AGENTIC-PIPELINE.ps1','tests\VERIFY-NATIVE-OLLAMA-LOOP.ps1','tests\VERIFY-MICRO-RUNTIME.ps1','tests\VERIFY-MODEL-EVAL-GOLD.ps1','tests\VERIFY-PLATFORM-GOLD.ps1','tests\evals\gold\python-feature\src\rate_limiter.py','tests\evals\gold\python-feature\tests\test_rate_limiter.py','tests\evals\lint\verify_python_quality.py','tests\evals\gold\java-refactor\src\main\java\eval\PriceCalculator.java','tests\evals\gold\java-refactor\src\test\java\eval\PriceCalculatorTest.java','tests\evals\gold\kotlin-feature\src\main\kotlin\eval\Slugifier.kt','tests\evals\gold\kotlin-feature\src\test\kotlin\eval\SlugifierTest.kt','tests\evals\hidden\SlugifierContractTest.kt','tests\evals\gold\rust-feature\src\lib.rs','tests\evals\gold\rust-feature\tests\port_test.rs','tests\evals\hidden\rust_port_contract.rs','tests\evals\gold\frontend-feature\src\index.html','tests\evals\gold\frontend-feature\src\styles.css','tests\evals\gold\frontend-feature\src\disclosure.mjs','tests\evals\gold\frontend-feature\tests\disclosure.test.mjs','tests\evals\lint\verify_frontend_quality.mjs',
...
Check 'Release scenario assets' {
 ...
 foreach($rel in @('tests\RUN-STARTUP-SMOKE.ps1','tests\RUN-SHELL-E2E.ps1','powershell\QUALIFY-RELEASE.ps1')){if(-not(Test-Path (Join-Path $root $rel))){throw "missing scenario asset: $rel"}}
}
