...
class PriceCalculatorContractTest {
  ...
  @Test void preservesEveryTierBoundary(){
    ...
    assertEquals(new BigDecimal("90.00"),c.total("SILVER",10,new BigDecimal("10"),"US").divide(new BigDecimal("1.07")).setScale(2,java.math.RoundingMode.HALF_UP));
    assertEquals(new BigDecimal("10.70"),c.total("STANDARD",1,new BigDecimal("10"),"US"));
  }
  @Test void preservesRounding(){assertEquals(new BigDecimal("1.33"),c.total("STANDARD",1,new BigDecimal("1.111"),"EU"));}
