...
if($smoke -notmatch '--allow Edit' -or $smoke -notmatch '--allow MultiEdit' -or $smoke -notmatch '--allow Write'){throw '[FAIL] real tool smoke lacks explicit headless write permissions'}
