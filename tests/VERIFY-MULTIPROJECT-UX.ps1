...
$u=Get-Content (Join-Path $root 'powershell\UNINSTALL.ps1') -Raw
...
Need 'installed uninstaller' "Copy-Item (Join-Path `$PackageRoot 'powershell\UNINSTALL.ps1') (Join-Path `$AgentHome 'UNINSTALL.ps1') -Force" $i
