...
Invoke-Test 'regression' 'MODEL-EVAL-GOLD' 'tests\VERIFY-MODEL-EVAL-GOLD.ps1'
Invoke-Test 'regression' 'PLATFORM-GOLD' 'tests\VERIFY-PLATFORM-GOLD.ps1'
Invoke-Test 'regression' 'ROLE-GIT-GATES' 'tests\VERIFY-ROLE-GIT-GATES.ps1'
Invoke-Test 'regression' 'SPRING-DATA-GOLD' 'tests\VERIFY-SPRING-DATA-GOLD.ps1'
Invoke-Test 'regression' 'ANDROID-GOLD' 'tests\VERIFY-ANDROID-GOLD.ps1'
